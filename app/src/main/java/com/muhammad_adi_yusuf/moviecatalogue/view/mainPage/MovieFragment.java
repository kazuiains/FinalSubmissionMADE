...
public class MovieFragment extends Fragment {
    ...
    private ArrayList<MovieCatalogueResultsItem> moviesItem = new ArrayList<>();
    ...
    private void initialize(View view) {
        ...
        //adapter
        adapter = new AdapterRecyclerView(getContext(), moviesItem);
        //recyclerView
    ...
    private void clickRecyclerView() {
        IcsRecyclerView.addTo(recyclerView).setOnItemClickListener(new IcsRecyclerView.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                ...
                MovieCatalogueResultsItem iTem = moviesItem.get(position);
                int idItem = iTem.getId();
                Intent intentJump = new Intent(getContext(), DetailActivity.class);
                intentJump.putExtra("idItem", idItem);
                intentJump.putExtra("type", getString(R.string.tab1));
